...
class Article extends Model
{
    ...
    public function getTrendingRadar()
    {
        ...
        if (!empty($results)) {
            ...
            $radar = [
                ['name' => 'مقالات مختارة', 'desc' => 'أبرز المنشورات والمحتوى المميز', 'icon' => 'general', 'label' => 'ترند صاعد', 'views' => '940 قراءة'],
                ['name' => 'شروحات عملية', 'desc' => 'أدلة وخطوات تطبيقية', 'icon' => 'tutorials', 'label' => 'اهتمام قياسي', 'views' => '820 قراءة'],
                ['name' => 'أقسام المنصة', 'desc' => 'تصنيفات المحتوى المتنوعة', 'icon' => 'general', 'label' => 'طلب واسع', 'views' => '710 قراءة'],
                ['name' => 'أحدث النقاشات', 'desc' => 'أكثر المواضيع تفاعلاً', 'icon' => 'general', 'label' => 'نمو متسارع', 'views' => '650 قراءة']
            ];
        }
