    ...
    public function privacy()
    {
        ...
        if (!$page) {
            $page = [
                ...
                'slug'     => 'privacy',
                'content_ar' => '<p>نحن في <strong>منصة الأخبار التقنية</strong> نولي خصوصية زوارنا ومستخدمينا أهمية قصوى. توضح هذه السياسة كيفية جمع واستخدام وحماية البيانات الشخصية وفق أعلى المعايير الأمنية.</p><h3>1. المعلومات التي نجمعها</h3><p>نقوم بجمع معلومات غير شخصية (مثل نوع المتصفح، نظام التشغيل، ونشاط الزيارة) لأغراض تحليلية وتحسين تجربة المستخدم، بالإضافة إلى المعلومات التي يقدمها المستخدم طواعية عند الاشتراك في النشرة البريدية أو التعليق أو استخدام نموذج التواصل.</p><h3>2. ملفات تعريف الارتباط (Cookies)</h3><p>نستخدم ملفات الكوكيز لتخصيص المحتوى وحفظ تفضيلات المظهر (الوضع الداكن/الفاتح) ولأغراض الأمان والحد من إساءة الاستخدام.</p><h3>3. حماية البيانات</h3><p>نطبق بروتوكولات حماية وتشفير متقدمة لمنع أي وصول غير مصرح به لبيانات الموقع.</p>'
            ];
        }
